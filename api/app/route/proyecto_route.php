...
$app->group('/proyecto',function(){
	...
	$this->get('/',function($req, $res, $args){
		return $res->withHeader('Content-type', 'aplication/json')
				   ->write(
				   		json_encode($this->model->Proyecto->listar())
				   	);	
	});
	...
	$this->get('/{id}',function($req, $res, $args){
		return $res->withHeader('Content-type', 'aplication/json')
				   ->write(
				   		json_encode($this->model->Proyecto->getProyecto($args['id']))
	...
	$this->post('/',function($req, $res, $args){
		...
		return $res->withHeader('Content-type', 'aplication/json')
			       -> write(
						json_encode($this->model->Proyecto->insert($req->getParsedBody()))

				   	);
	});

	$this->post('/insertarPS/',function($req, $res, $args){
		// $r = UserValidation::validate($req->getParsedBody());
		...
		return $res->withHeader('Content-type', 'aplication/json')
			       -> write(
						json_encode($this->model->Proyecto->insertProyectoSprint($req->getParsedBody()))
	...
	$this->put('/{id}',function($req, $res, $args){
		...
		return $res->withHeader('Content-type', 'aplication/json')
				   ->write(
				   		json_encode($this->model->Proyecto->update($req->getParsedBody(), $args['id'] ))
	...
	$this->delete('/{id}',function($req, $res, $args){
		return $res->withHeader('Content-type', 'aplication/json')
				   ->write(
				   		json_encode($this->model->Proyecto->delete($args['id']))
				   	);
	});
});	
