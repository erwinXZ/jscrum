...
var self ={
				...
				insertar : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.43.178/Web/jscrum/api/public/usuario/',
				...
				logIn : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.43.178/Web/jscrum/api/public/usuario/login/',
                        // url: 'http://localhost/gitgrad/APIPOLLO/public/observation/read/',
                        data:{
								_login:datos.login,
								_password:datos.password
				...
				modificarFoto : function(){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.43.178/Web/jscrum/api/public/usuario/updatePhoto/',
						  data:{
								_email:user.email,
						}
                    	})
				...
				insertarUsuario : function(user){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.43.178/Web/jscrum/api/public/usuario/insertarMiembro/',
						  data:{
								_id_usuario:user.id,
								_destrezas:user.des
						}
