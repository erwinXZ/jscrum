...
var self ={
				...
				insertarProyecto : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/proyecto/',
				...
				insertarEquipo : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/equipo/',
                        // url: 'http://localhost/gitgrad/APIPOLLO/public/observation/read/',
                        data:{
				...
				insertarPila : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/pila/',
                        // url: 'http://localhost/gitgrad/APIPOLLO/public/observation/read/',
                        data:{
								_codigo:datos.codigo,
				...
				listar : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/equipo/listarEquipos/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarM : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/equipo/listarEquiposM/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarProyectos : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/proyecto/listarProyectos/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarProyecto : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/proyecto/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarPila : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/pila/listarPila/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				idManager : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/manager/idManager/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				idMiembro : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/miembro/idMiembro/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarSprint : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.2/Web/jscrum/api/public/sprint/listarSprint/'+id,
                    	})
                        .then(function successCallback(response) {
								self.response 	= response.data;
