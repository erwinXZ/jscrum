...
var self ={
				...
				insertarPila : function(datos){
                    ...
                    $http({
                      method: 'POST',
					  	url: 'http://192.168.1.14/Web/jscrum/api/public/pila/',
                        // url: 'http://localhost/gitgrad/APIPOLLO/public/observation/read/',
                        data:{
								_codigo:datos.codigo,
				...
				listarProyecto : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.14/Web/jscrum/api/public/proyecto/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
				...
				listarPila : function(id){
                    ...
                    $http({
                      method: 'GET',
					  	url: 'http://192.168.1.14/Web/jscrum/api/public/pila/listarPila/'+id,
                    	})
                        .then(function successCallback(response) {
                                // ok
                                // self.cargado		= true;
